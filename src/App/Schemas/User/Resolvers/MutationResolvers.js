  ...
  Mutation: {
    ...
    async forgotMyPassword(_, { email }) {
      ...
      try {
        ...
        const msg =
          'New password requested with success. Please, check your Email!';
        return {
          msg,
          user: update
        };
        ...
        const msg =
          'Error while requesting the service "forgot my password". Try again!';
    ...
    async resetPassword(_, { email, token, password }) {
      ...
      try {
        ...
        if (user.passwordResetUsed) {
          const msg =
            'Token Already Used. Please, request a new password again!';
          throw TokenError(msg);
        }
        ...
        const msg =
          'Error on requesting the service "reset password". Try again!';
        throw ServiceError(msg);
      }
    }
  }
